...
// js file and its css deps are added as rel=modulepreload (by vite). This won't work if `base` in vite.config.js
// doesn't point to `build.outDir` folder
import '../scss/app/dynamic-import-dependency.scss';

// this chunk shouldn't be loaded at page load and shouldn't be in modulepreload tags at page load
